...
export async function DetalheProjeto({ projetoId }: InfosGeraisProps) {
    const resp = await ProjetoApi.getInstance().getProjeto(projetoId);
    const projeto = resp.data as Projeto;
